...
const Index = () => {
  ...
  return (
    <Box p={8} display="flex" flexDirection="column" alignItems="center" justifyContent="center" height="100vh">
      <VStack spacing={4} width="full" maxW="container.md">
        <Text fontSize="2xl" mb={4}>Simple Image Editor</Text>
        <Input type="file" accept="image/*" onChange={handleImageChange} />
        {image && (
          <>
            <Image src={image} alt="Uploaded" style={{ filter: applyFilter() }} />
            ...
            <Button onClick={downloadImage} colorScheme="blue">Download Edited Image</Button>
          </>
        )}
      </VStack>
    </Box>
